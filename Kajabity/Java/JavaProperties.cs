...
namespace Kajabity.Tools.Java
{
    ...
    public class JavaProperties : Hashtable
    {
        ...
        /// <summary>
        /// A constructor that creates a copy of another JavaProperties.
        /// </summary>
        public JavaProperties(JavaProperties jp)
        {
            for (IEnumerator e = jp.Keys.GetEnumerator(); e.MoveNext(); )
            {
        ...
        public void Report()
        {
            ...
            {
                string key = AsString(e.Current);
                Console.WriteLine(@"Key: [{0}] Value: [{1}]", key, this[key]);
            }
        }
